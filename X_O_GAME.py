...
def winner_check():
    ...
    if cube_1["text"] == "X" and cube_2["text"] == "X" and cube_3["text"] == "X":
        ...
        messagebox.showinfo("Tic_Tac_Toe", "Player 1 Win !")
        winner = True
        winner_player = "X"
        x_points += 1
        ...
        cube_2.config(bg="red")
        cube_3.config(bg="red")
        messagebox.showinfo("Tic_Tac_Toe", "Player 2 Win !")
        winner = True
        winner_player = "O"
        o_points += 1
...
label_for_score = Label(root, font=("arial", 20))
label_for_score.grid(row=3, column=1, pady=10)

players_scores = Label(root, text="0 - 0", font=("arial", 20))
players_scores.grid(row=4, column=1, pady=10)
...
reset_score_button.grid(row=6, column=1, pady=5)
